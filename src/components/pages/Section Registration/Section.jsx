  ...
  return (
    <>
      ...
      <div className="mx-40 my-20">
        ...
        <ul className="my-2">
          <p className="">
            Registering a Section 8 Company is quick, easy, and can be done
            online with Medsys in 3 simple steps:
          </p>
          <div>
        ...
        <div className="bg-[#f6d5dd] h-full w-9/12 px-12 py-4 ">
          <div className="my-12" id="Overview">
            ...
            <p className="my-2">
              ...
              conditions for granting the license is.
            </p>
            <p className="">
          ...
          <div className="my-12" id="Requirements">
            ...
            <ul className="my-2">
              <p className="text-[#9D3E55] mr-2 text-lg font-semibold">
                Provisional Patent:
              </p>
              <li className="">
                <span className="text-[#9D3E55] mr-2 arrow text-lg font-semibold">
                  Governed by:
                </span>
                Companies Act, 2013.
              </li>
              ...
              <li className="">
                ...
                MoA, AoA and financial statements.
              </li>
              <li className="">
                <span className="text-[#9D3E55] mr-2 arrow text-lg font-semibold">
                  Board:
              ...
              <li className="">
                ...
                of the company. These can be sold in conformity to the
                provisions mentioned in the Companies Act, 2013. The Act says
                the sale can be done with prior consent of the Company Board of
                Directors, when they pass a resolution regarding the same.
              </li>
              <li className="">
                <span className="text-[#9D3E55] mr-2 arrow text-lg font-semibold">
              ...
              <li className="">
                ...
                The company must ensure its annual compliance by filing its
                annual returns and annual accounts with the RoC.
              </li>
            </ul>
          </div>
          ...
          <div className="my-12" id="Documents">
            ...
            <ul className="">
              ...
              <li className="arrow">
                Financial statements like assets and liabilities, the projection
                for five years etc.
              </li>
              <li className="arrow">Directors personal documents.</li>
              <li className="arrow">
                Registered office address documents viz. rental agreement or
                sale deed in the name of the company, utility bills not older
                than two months.
              </li>
            </ul>
          </div>
          <div className="my-12" id="Advantages">
            ...
            <p>
              The following are the advantages of incorporating a Section 8
              company over other modes of registering an NGO:
            </p>
            <ul className="">
              <li className="arrow">
              ...
              <li className="arrow">
                Avoids meticulous registration process and no physical presence
                required.
              </li>
              <li className="arrow">
              ...
              <li className="arrow">
                Seamless procurement of tax benefits under section 12AA and 80G
                of the Income Tax Act.
              </li>
              <li className="arrow">
                Any partnership firm can be a member in its individual capacity
                and obtain Directorship.
              </li>
            </ul>
          ...
          <div className="my-12" id="FAQs">
            ...
            <Accordion>
              <AccordionItem>
                <AccordionItemHeading>
                  <AccordionItemButton>
                    a.Is there any maximum limit for the number of members in
                    the Section 8 company?
                  </AccordionItemButton>
                </AccordionItemHeading>
                <AccordionItemPanel>
                  <p>There is no such maximum limit.</p>
                </AccordionItemPanel>
              </AccordionItem>
              <AccordionItem>
                <AccordionItemHeading>
                  <AccordionItemButton>
                    b. Can any government employees or officer be a member of
                    NGO?
                  </AccordionItemButton>
                </AccordionItemHeading>
                <AccordionItemPanel>
              ...
              <AccordionItem>
                ...
                <AccordionItemPanel>
                  <p>
                    ...
                    TradeMarks (CGPDTM) generally known as the Indian Patent
                    Office, is an agency under the Department for Promotion of
                    Industry and Internal Trade which administers the Indian law
              ...
              <AccordionItem>
                ...
                <AccordionItemPanel>
                  <p>
                    The property of the company vests in the name of the Company
                    and the same can be sold as per the rules mentioned under
                    the Companies Act, (Eg: With the consent of the Board of
              ...
              <AccordionItem>
                <AccordionItemHeading>
                  <AccordionItemButton>e. Still Confused?</AccordionItemButton>
                </AccordionItemHeading>
                <AccordionItemPanel>
                  <p>
                    Patents linked to any agriculture or horticulture-related
                    process or processes related to atomic energy are not
                    eligible for grants. e.g. inventions in relation to uranium,
                    beryllium, thorium, radium, graphite, lithium etc as
                    specified by the Central Government. The topography of
                    integrated circuits also cannot be patented in India.
                  </p>
                </AccordionItemPanel>
              </AccordionItem>
            </Accordion>
