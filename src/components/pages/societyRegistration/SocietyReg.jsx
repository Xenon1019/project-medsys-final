    ...
    return (<>
        <div className="application" style={
            ...
            <div className="header-left-content">
                <h1>Online Society Registration India</h1> <br />
                <p>Registration of society is required to promote the fine arts, science, literature, or knowledge sharing for a
                    purposeful matter or for charity.</p><br />
