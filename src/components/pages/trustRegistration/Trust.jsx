        ...
        <div className='font-serif'>
            <div className='h-[34rem] flex py-24 px-16 bg-cover didot' style={{ backgroundImage: `url(${bg})` }}>
                <div className='text-white flex flex-col justify-between' >
                    <h2 className='text-5xl font-bold '>Registration of a Trust</h2>
                    <p className='text-lg mr-20'>Trust implies the transfer of a property (cash, shares or valuable asset) from the owner to another person. There are two types of trusts – Private and Public. A private trust is formed for the benefit of a group of people. Public trust is formed for the benefit of the general public.</p>
                    <div>
            ...
            <div className='flex justify-between items-center px-16 bg-black text-white h-20'>
                <div className='text-2xl'>Contact us to know more about Trust Registration</div>
                <div>
            ...
            <div className='mx-40 my-20'>
                ...
                <ul className='my-2'>
                    <p className=''>Trust Registration requires important documents like trust deed and rental agreement. Our service experts help you with the complete procedure for the formation of trust while taking care of all the legal intricacies</p>
                    <div>
                        <li className='text-[#9D3E55] mr-2 arrow text-lg font-semibold'>  Step 1: </li>
                        <p className='my-4'>We address all your queries about Trust registration online</p>
                    </div>
                    <div>
                        <li className='text-[#9D3E55] mr-2 arrow text-lg font-semibold'>  Step 2: </li>
                        <p className='my-4'>We help you get the entire process of filing and registration completed.</p>
                    </div>
                    <div>
                        <li className='text-[#9D3E55] mr-2 arrow text-lg font-semibold'>  Step 3: </li>
                        <p className='my-4'>We help you with the post-registration formalities and compliances.</p>
                    </div>
            ...
            <div className='flex bg-[#f6d5dd] h-full w-full'>
                    ...
                    <div className='flex flex-col sticky top-40 ml-4 my-12'>
                        <div className='bg-white rounded-xl  p-2 '>
                            ...
                            <Scrollspy items={[
                                ...
                                <li><a className=' text-gray-500 hover:text-[#560216] hover:underline hover:font-bold my-1 ' href='#How'>How to Register a Trust</a></li>
                                <li><a className=' text-gray-500 hover:text-[#560216] hover:underline hover:font-bold my-1 ' href='#Content'>Content of the Trust Deed</a></li>
                                ...
                                <li><a className=' text-gray-500 hover:text-[#560216] hover:underline hover:font-bold my-1 ' href='#Constitution'>Constitution of the Trust</a></li>
                                <li><a className=' text-gray-500 hover:text-[#560216] hover:underline hover:font-bold my-1 ' href='#Why'>Why register a trust?</a></li>
                                <li><a className=' text-gray-500 hover:text-[#560216] hover:underline hover:font-bold my-1 ' href='#Compliances'>Trust Compliances</a></li>
                                <li><a className=' text-gray-500 hover:text-[#560216] hover:underline hover:font-bold my-1 ' href='#Applicability'>Applicability of tax exemption</a></li>
                ...
                <div className='bg-[#f6d5dd] h-full w-9/12 px-12 py-4 '>
                    ...
                    <div className='my-12' id="Overview">
                        ...
                        <p className='my-2'>Public Trust is the most convenient way of starting a non-governmental organization or NGO. A trust functions on the objective of eradicating poverty, providing education to the underprivileged and offering medical relief apart from the generalized aim of promoting arts, science and literature. It is to be noted that trusts are irrevocable which means they cannot be amended or terminated without the permission of the court. Vakilsearch helps in providing you with the trust registration certificate with a few documents like a deed of trust, rental agreement, etc.</p>
                        <p className=''>In India, there are no specific laws to govern the public trust, however, some states like Maharashtra and Tamil Nadu have their own public trust Act.</p>


                    </div>

                    <div className='my-12' id="How">
                        <h2 className='text-3xl text-[#560216] font-bold my-4'>How to Register a Trust</h2>
                        <p className='my-2'>Medsys helps you in providing with the trust registration online through very simple steps. As an initial step in registering the trust, the founder of the trust or the “Author of the Trust” or the “Settlor of the Trust” has to figure out in a document the objectives of the trust and the manner in which the trustees have to work towards achieving the goals of the Trust. This document that contains all such details is called a Trust Deed, which is also called a deed of trust.</p>
                        <p className=''>Once this is made, thereafter, an application for registration of the trust shall be moved before the Registrar of Trust along with the Trust Deed or a deed of trust. The appropriate jurisdiction for registration of the trust is usually where the registered office of the trust is located.</p>
                    ...
                    <div className='my-12' id="Content">
                        <h2 className='text-3xl text-[#560216] font-bold my-4'>Content of the Trust Deed</h2>
                        <p>The trust deed is the primary and the most essential document of the trust which states the reason for forming a trust, its functions, to its working, and until its closure. Following are the important clauses in the Trust Deed:</p>
                        <ul className=''>
                            ...
                            <li className="arrow">Quorum of the Board with their qualification, terms and tenure</li>
                            <li className="arrow">Powers and functions of the Managing Trustee and other Trustees</li>
                            <li className="arrow">Closure and amendment of the trust deed and the applicability of the Act</li>
                        </ul>
                    </div>


                    <div className='my-12' id="Documents">
                        <h2 className='text-3xl text-[#560216] font-bold my-4'>Documents Required for trust registration certificate</h2>
                        <p>To get your trust registration certificate, you should require the following documents during the registration of the Trust:</p>
                        <ul className=''>
                            <li className="arrow">A completely drafted trust deed</li>
                            <li className="arrow">Proof of registered office - (Rental Agreement or ownership document)</li>
                    ...
                    <div className='my-12' id="Constitution">
                        <h2 className='text-3xl text-[#560216] font-bold my-4'>Constitution of the Trust</h2>
                        <p>The Trust constitutes the Board of Trustees. The Board constitutes the following:</p>
                        <ul className=''>
                            ...
                            <p>The quorum of the Board of Trustees shall not exceed a maximum of 21 members.</p>
                            
                        </ul>
                    </div>

                    <div className='my-12' id="Why">
                        <h2 className='text-3xl text-[#560216] font-bold my-4'>Why register a trust?</h2>
                        <ul className=''>
                            <li className="arrow">As per the Public Trust Act of all states, registration of Trust is mandatory if it involves charitable purpose or when there is a transfer of immovable property in the name of the trust.</li>
                            <li className="arrow">Only registered trust is eligible for tax exemptions provided under Section 12 A and 80G of the Income Tax Act.</li>
                            <li className="arrow">Registering a trust adds more credibility to the same as it involves public money in the form of donations.</li>
                    ...
                    <div className='my-12' id="Compliances">
                        <h2 className='text-3xl text-[#560216] font-bold my-4'>Trust Compliances</h2>
                        ...
                        <ul className=''>
                            ...
                            <li className="arrow">Shops and Establishment License - in case of employment</li>
                    ...
                    <div className='my-12' id="Applicability">
                        <h2 className='text-3xl text-[#560216] font-bold my-4'>Applicability of tax exemption</h2>
                        <p>There is a general notion that trust need not have to pay tax as they work towards the welfare of the public at large. But this is not true. A trust, like any other legal entity, is liable to pay tax. In order to be exempted from tax, trust is required to obtain certification for the said exemptions such as Section 12 A, 80G etc. from the Income Tax authorities.</p>
                    ...
                    <div className='my-12' id="FAQs">
                        ...
                        <Accordion>
                            ...
                            <AccordionItem>
                                <AccordionItemHeading>
                                    <AccordionItemButton>
                                    c.Are government employees or officers allowed to be members of NGO?
                                    </AccordionItemButton>
                                </AccordionItemHeading>
                                <AccordionItemPanel>
                                    <p>
